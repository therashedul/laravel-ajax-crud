                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="" data-toggle="modal" data-target="#updateproduct"
                                            ...
                                            class="update-product"><i class="fas fa-edit"></i> </a>
                ...
                <form id="up-product-form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 ">
                                <label for="prodcutName">Status</label>
                                <input type="hidden" class="js-switch status" id="up-status" name="status">
                                <input type="checkbox" class="js-switch status" id="up-status" name="status">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
